          ...
          <div className="lg:col-span-8 bg-white border border-border-light rounded-[32px] overflow-hidden min-h-[420px] shadow-sm relative flex flex-col group">
            ...
            <div className="absolute top-4 left-4 bg-white/95 backdrop-blur-md px-3.5 py-2.5 rounded-2xl border border-border-light shadow-md flex items-center space-x-2.5 pointer-events-none">
              ...
              <div className="text-left">
                <p className="text-[13px] font-bold text-primary">{clinicData.address.doctorName}</p>
                <p className="text-[11px] text-slate-600 font-medium">Kusum Vihar, Lane 5, SKIT Road, Jagatpura</p>
              </div>
            </div>
            ...
            <div className="absolute bottom-4 right-4">
              <a
                ...
                className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-primary/95 hover:bg-secondary text-white text-[13px] font-bold shadow-lg backdrop-blur-md transition-all transform hover:-translate-y-0.5 cursor-pointer"
              >
          ...
          <div className="lg:col-span-4 bg-white border border-border-light rounded-[32px] p-6 sm:p-8 flex flex-col justify-between shadow-sm">
            <div className="space-y-6">
              <div>
                ...
                <p className="text-[15px] font-semibold text-text-dark leading-relaxed">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-6 w-full inline-flex items-center justify-center py-3.5 px-4 rounded-2xl bg-accent text-white font-bold text-[13px] shadow-md hover:bg-secondary cursor-pointer transition-all active:scale-[0.98]"
            >
