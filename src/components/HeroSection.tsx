      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-5 w-full max-w-[460px] mx-auto flex flex-col space-y-3.5">
            ...
            {/* Main Interactive Doctor Card (Full photo visible, details cleanly below) */}
            <div className="bg-white rounded-[28px] overflow-hidden shadow-xl border border-border-light flex flex-col w-full">
              {/* Full Doctor Photo Container (Zero overlay covering the photo) */}
              ...
              {/* Doctor Details (Cleanly positioned below the photo) */}
              <div className="p-4 sm:p-5 space-y-3 text-left bg-white">
                <div className="space-y-1">
                  <div className="flex items-center justify-between flex-wrap gap-1">
                    <div className="flex items-center space-x-1.5 text-emerald-700 text-[12px] font-semibold">
                  ...
                  <p className="text-[12px] text-slate-600 font-normal line-clamp-1">
                    {currentDoc.hospital}
                  </p>
                </div>
                ...
                <div className="flex items-center gap-2.5 pt-1">
                  <button
                    type="button"
                    onClick={onOpenAppointment}
                    className="flex-1 py-2.5 px-4 rounded-xl bg-accent hover:bg-accent/90 text-white text-[13px] font-bold text-center shadow-md transition-all cursor-pointer hover:shadow-lg active:scale-[0.98]"
                  >
                    Book Appointment
                  </button>
                  <Link
                    href={`/doctor/${currentDoc.id}`}
                    className="py-2.5 px-3.5 rounded-xl bg-primary/5 hover:bg-primary/10 border border-primary/15 text-primary text-[13px] font-bold text-center transition-all flex items-center justify-center space-x-1 cursor-pointer active:scale-[0.98]"
                  >
                    <span>Profile</span>
